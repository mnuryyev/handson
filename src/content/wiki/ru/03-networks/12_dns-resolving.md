...
Когда мы вводим google.com в браузере, происходит цепочка DNS запросов. Есть два принципиально разных способа как эти запросы обрабатываются - рекурсивный и итеративный. Понимание разницы помогает диагностировать проблемы, настраивать резолверы и понимать где что может сломаться.
